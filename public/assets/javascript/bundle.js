...
"use strict";function _interopRequireDefault(r){return r&&r.__esModule?r:{"default":r}}Object.defineProperty(exports,"__esModule",{value:!0});var _AppController=require("../controllers/AppController1"),_AppController2=_interopRequireDefault(_AppController),_AppController3=require("../controllers/AppController2"),_AppController4=_interopRequireDefault(_AppController3),_registerHelper=require("./register-helper"),controllers=angular.module("controllers",[]).controller("AppController1",(0,_registerHelper.controller)(_AppController2["default"])).controller("AppController2",(0,_registerHelper.controller)(_AppController4["default"]));exports["default"]=controllers;

},{"../controllers/AppController1":302,"../controllers/AppController2":303,"./register-helper":300}],300:[function(require,module,exports){
"use strict";function directive(r){r=_normalizeConstructor(r),r.prototype.compile||(r.prototype.compile=function(){});var t=_cloneFunction(r.prototype.compile);_override(r.prototype,"compile",function(){return function(){return t.apply(this,arguments),r.prototype.link?r.prototype.link.bind(this):void 0}});var e=_createFactoryArray(r);return e}function controller(r){return r}function service(r){return r}function provider(r){return r}function factory(r){r=_normalizeConstructor(r);var t=_createFactoryArray(r);return t}Object.defineProperty(exports,"__esModule",{value:!0}),exports.directive=directive,exports.controller=controller,exports.service=service,exports.provider=provider,exports.factory=factory;var _normalizeConstructor=function(r){var t;if(r.constructor===Array){var e=r.slice(0,r.length-1);t=r[r.length-1],t.$inject=e}else t=r;return t},_createFactoryArray=function(r){var t=r.$inject||[],e=t.slice();return e.push(function(){for(var t=arguments.length,e=Array(t),o=0;t>o;o++)e[o]=arguments[o];var n=new(Function.prototype.bind.apply(r,[null].concat(e)));for(var c in n)n[c]=n[c];return n}),e},_cloneFunction=function(r){return function(){return r.apply(this,arguments)}},_override=function(r,t,e){r[t]=e(r[t])};

},{}],301:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}var _controllersModule=require("./angular-modules/controllers-module"),_controllersModule2=_interopRequireDefault(_controllersModule);require("babel-polyfill");var app=angular.module("DemoApp","dialog.templates",["ngRoute","ngAnimate","ngMessages","ngDialog","controllers"]),AppController1=require("./controllers/AppController1.js"),myCustomer=require("./directives/my-customer.js"),ordinal=require("./filters/ordinal.js"),notify=require("./services/notify.js");app.controller("AppController1",["$scope","notify","ngDialog",AppController1]).directive("myCustomer",myCustomer).filter("ordinal",ordinal).factory("notify",["$window",notify]),app.config(["$routeProvider",function(e){e.when("/",{templateUrl:"assets/views/main.html"}).when("/controller",{template:"This is the computers Route. And the message is {{ctrl.message}}",controller:"AppController1 as ctrl"}).when("/animation",{templateUrl:"assets/views/animate.html"}).when("/message",{templateUrl:"assets/views/message.html"}).when("/directive",{templateUrl:"assets/views/directive.html",controller:"AppController1 as ctrl"}).when("/filter",{templateUrl:"assets/views/filter.html"}).when("/service",{templateUrl:"assets/views/service.html"}).when("/dialog",{templateUrl:"assets/views/dialog.html"}).otherwise({redirectTo:"/"})}]);

},{"./angular-modules/controllers-module":299,"./controllers/AppController1.js":302,"./directives/my-customer.js":304,"./filters/ordinal.js":305,"./services/notify.js":309,"babel-polyfill":1}],302:[function(require,module,exports){
"use strict";function _classCallCheck(e,o){if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var AppController1=function e(o,t,n){_classCallCheck(this,e);var l=this;l.message="Hello",l.doSomething=function(){l.message="Bye"},l.customer={name:"Alex",address:"Kanzelstr. 5"},o.callNotify=function(e){t(e)},o.clickToOpen=function(){n.open({template:"templateID"})},o.test=function(){console.log("AaA")}};exports["default"]=AppController1,AppController1.$inject=["$scope","notify","ngDialog"];

},{}],303:[function(require,module,exports){
"use strict";function _classCallCheck(e,o){if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var AppController2=function e(o,t,n){_classCallCheck(this,e);var l=this;l.message="Hello",l.doSomething=function(){l.message="Bye"},l.customer={name:"Alex",address:"Kanzelstr. 5"},o.callNotify=function(e){t(e)},o.clickToOpen=function(){n.open({template:"templateID"})},o.test=function(){console.log("AaA")}};exports["default"]=AppController2,AppController2.$inject=["$scope","notify","ngDialog"];

},{}],304:[function(require,module,exports){
"use strict";module.exports=function(){return{controller:"AppController1",link:function(e,r,t,o){},template:"Name: {{ctrl.customer.name}} Address: {{ctrl.customer.address}}"}};

},{}],305:[function(require,module,exports){
"use strict";module.exports=function(){return function(r){if(void 0==r||""==r)return"";if(isNaN(r)||1>r)return"Not a number: "+r;var u=r%10;return 1===u?"Your number: "+r+"st":2===u?"Your number: "+r+"nd":3===u?"Your number: "+r+"rd":u>3?"Your number: "+r+"th":void 0}};

},{}],306:[function(require,module,exports){
"use strict";function funct(r){return r+1}function func2(r){return r+1}var variable="var1",var2="var2";module.exports.variable=variable,module.exports.funct=funct;

},{}],307:[function(require,module,exports){
"use strict";module.exports=function(e){return"Hello "+e+"!"};

},{}],308:[function(require,module,exports){
"use strict";module.exports=function(t,e){return t*e};

},{}],309:[function(require,module,exports){
"use strict";module.exports=function(n){var t=[];return function(e){t.push(e),3==t.length&&(n.alert(t.join("\n")),t=[])}};
